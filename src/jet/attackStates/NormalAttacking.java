...
public class NormalAttacking extends Attacking {
    public static final String SHOOT = "shoot";

    public NormalAttacking(Jet jet, StateMachine stateMachine, List<? extends State> states){
